// model/repository/NameDataRepositoryImpl.kt
...
class NameDataRepositoryImpl : NameDataRepository {
    ...
    private var charTripleDict: Map<String, NameData.CharTripleInfo> = emptyMap()
    private var optimizedMapping: NameData.OptimizedMapping? = null
    ...
    override fun getCharInfo(tripleKey: String): NameData.CharTripleInfo? = charTripleDict[tripleKey]

    override fun getCharInfo(korean: String, hanja: String): NameData.CharTripleInfo? =
    ...
    override fun getStats(): NameData.MappingStats? = optimizedMapping?.stats
}