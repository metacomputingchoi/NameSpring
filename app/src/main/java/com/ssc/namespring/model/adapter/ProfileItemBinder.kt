// model/adapter/ProfileItemBinder.kt
...
class ProfileItemBinder(
    ...
    private fun bindOhaengDistribution(ohaeng: com.ssc.namespring.model.data.OhaengInfo) {
    ...
    private fun bindOhaengBalance(ohaeng: com.ssc.namespring.model.data.OhaengInfo) {
