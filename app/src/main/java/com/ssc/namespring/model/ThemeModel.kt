...
class ThemeModel {
    ...
    fun getThemeColors(theme: Theme): ThemeColors {
        return ThemeColors(
            ...
            textPrimary = when (theme.weatherType) {
                WeatherType.SUNNY, WeatherType.WARM -> android.R.color.black
                else -> android.R.color.white
            },
            textSecondary = when (theme.weatherType) {
                WeatherType.SUNNY, WeatherType.WARM -> android.R.color.darker_gray
                else -> android.R.color.holo_blue_light
            },
            accent = when (theme.sproutState) {
                SproutState.BLOOMING -> com.ssc.namespring.R.color.flower_pink
                SproutState.GROWING -> com.ssc.namespring.R.color.leaf_green
                SproutState.SPROUTING -> com.ssc.namespring.R.color.sprout_green
                SproutState.SEED -> com.ssc.namespring.R.color.seed_brown
                SproutState.DORMANT -> com.ssc.namespring.R.color.dormant_gray
            }
        )
    }
    ...
    fun getThemeGradientColors(theme: Theme): Pair<Int, Int> {
        return when (theme) {
            Theme.SUNNY_SPRING -> com.ssc.namespring.R.color.sunny_spring_bg to
                    com.ssc.namespring.R.color.sunny_spring_accent
            Theme.WARM_SPRING -> com.ssc.namespring.R.color.warm_spring_bg to
                    com.ssc.namespring.R.color.warm_spring_accent
            Theme.CLOUDY_SPRING -> com.ssc.namespring.R.color.cloudy_spring_bg to
                    com.ssc.namespring.R.color.cloudy_spring_accent
            Theme.RAINY_SPRING -> com.ssc.namespring.R.color.rainy_spring_bg to
                    com.ssc.namespring.R.color.rainy_spring_accent
            Theme.COLD_SPRING -> com.ssc.namespring.R.color.cold_spring_bg to
                    com.ssc.namespring.R.color.cold_spring_accent
            else -> com.ssc.namespring.R.color.background to com.ssc.namespring.R.color.primary
        }
    }
