// namingengine/src/main/java/com/ssc/namingengine/core/NamingSystem.kt
package com.ssc.namingengine.core

import com.ssc.namingengine.common.parsing.ParsingConstants
import com.ssc.namingengine.data.GeneratedName
import com.ssc.namingengine.service.SajuCalculator
...
class NamingSystem(
    ...
    // 내부 서비스 접근 메서드 추가
    fun getSajuCalculator(): SajuCalculator {
        require(isInitialized) { "NamingSystem이 초기화되지 않았습니다." }
        return services.sajuCalculator
    }

    fun getSurnameValidator(): SurnameValidator {
        require(isInitialized) { "NamingSystem이 초기화되지 않았습니다." }
        return services.surnameValidator
    }
